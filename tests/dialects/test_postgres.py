...
FROM json_data, field_ids""",
    ...
    def test_ddl(self):
        ...
        self.validate_identity("CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY)")
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED BY DEFAULT AS IDENTITY (INCREMENT 2))",
            "CREATE TABLE t (a INT GENERATED BY DEFAULT AS IDENTITY (INCREMENT BY 2))",
        )
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (START 1 INCREMENT 2))",
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 2))",
        )
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (MINVALUE 1 MAXVALUE 100))"
        )
        self.validate_identity("CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (CACHE 10))")
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (CACHE 10 NO CYCLE))"
        )
        self.validate_identity("CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (NO CYCLE))")
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 2 MINVALUE 0 MAXVALUE 100 CACHE 5 CYCLE))"
        )
        self.validate_identity(
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (1, 2))",
            "CREATE TABLE t (a INT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 2))",
        )
